...
[StructLayout(LayoutKind.Sequential)]
public class NvBlastExtImpactSpreadDamageDesc
{
    public float damage;       //!<	normalized damage amount, range: [0, 1] (maximum health value to be reduced)
    public float p0;
    public float p1;
...
public static class NvBlastExtShadersWrapper
{
    ...
    [DllImport(DLL_NAME)]
    public static extern void NvBlastExtImpactSpreadGraphShader(NvBlastFractureBuffers buffers, NvBlastGraphShaderActor actor, NvBlastExtProgramParams p);    // System.IntPtr xparams

    [DllImport(DLL_NAME)]
    public static extern void NvBlastExtImpactSpreadSubgraphShader(NvBlastFractureBuffers buffers, NvBlastSubgraphShaderActor actor, NvBlastExtProgramParams p);    // NvBlastExtProgramParams
    #endregion
