...
public class NvFractureTool : DisposablePtr
{
    ...
    //[DllImport("NvBlastExtAuthoring_x64")]
    //private static extern IntPtr NvBlastExtAuthoringProcessFracture(IntPtr fractureTool, IntPtr bondGenerator, IntPtr collisionBuilder, IntPtr collisionParam, int supportDepth);

    [DllImport("NvBlastExtUnity_x64")]
    private static extern IntPtr _AuthoringTool_ProcessFracture(IntPtr fractureTool);
    ...
    public NvBlastAuthoringResult processFracture()
    {
        IntPtr arPtr = _AuthoringTool_ProcessFracture(this.ptr);
        return new NvBlastAuthoringResult(arPtr);
    }
...
public class NvBlastTkAsset : DisposablePtr
{
    [DllImport("NvBlastExtUnity_x64")]
    private static extern IntPtr _TKAsset_Deserialize(string filename);
    [DllImport("NvBlastExtUnity_x64")]
    private static extern IntPtr _TKAsset_DeserializeFromBytes(IntPtr byteData, int byteCount);
    [DllImport("NvBlastExtUnity_x64")]
    private static extern void _TKAsset_Release(IntPtr tkAsset);
    [DllImport("NvBlastExtUnity_x64")]
    private static extern int _TKAsset_GetBondCount(IntPtr tkAsset);
    [DllImport("NvBlastExtUnity_x64")]
    private static extern int _TKAsset_GetChunkCount(IntPtr tkAsset);
    [DllImport("NvBlastExtUnity_x64")]
    private static extern IntPtr _TKAsset_GetChunk(IntPtr tkAsset, int chunkIndex);
    [DllImport("NvBlastExtUnity_x64")]
    private static extern IntPtr _TKAsset_GetBond(IntPtr tkAsset, int bondIndex);
    [DllImport("NvBlastExtUnity_x64")]
    private static extern IntPtr _TKAsset_GetAssetLL(IntPtr tkAsset);

    public static NvBlastTkAsset Deserialize(string filename)
    {
        IntPtr me = _TKAsset_Deserialize(filename);
        return new NvBlastTkAsset(me);
    }

    public static NvBlastTkAsset Deserialize(TextAsset asset)
    {
        IntPtr ptr = Marshal.AllocHGlobal(asset.bytes.Length);
        Marshal.Copy(asset.bytes, 0, ptr, asset.bytes.Length);
        IntPtr me = _TKAsset_DeserializeFromBytes(ptr, asset.bytes.Length);
        Marshal.FreeHGlobal(ptr);

        return new NvBlastTkAsset(me);
    }

    private NvBlastTkAsset(IntPtr me)
    {
        Initialize(me);
    }
    ...
    {
        return _TKAsset_GetBondCount(this.ptr);
    }

    public int GetChunkCount()
    {
        return _TKAsset_GetChunkCount(this.ptr);
    }

    public NvBlastBond GetBond(int bondIndex)
    {
        unsafe
        {
            NvBlastBond* bond = (NvBlastBond*)_TKAsset_GetBond(this.ptr, bondIndex);
            return *bond;
        }
    }

    public NvBlastChunk GetChunk(int chunkIndex)
    {
        unsafe
        {
            NvBlastChunk* chunk = (NvBlastChunk*)_TKAsset_GetChunk(this.ptr, chunkIndex);
            return *chunk;
        }
    }

    public NvBlastAsset GetAssetLL()
    {
        IntPtr ptr = _TKAsset_GetAssetLL(this.ptr);
        NvBlastAsset asset = new NvBlastAsset(ptr);
        return asset;
    ...
    protected override void Release()
    {
        _TKAsset_Release(this.ptr);
    }
}

public class NvBlastAuthoringResult : DisposablePtr {

    [DllImport("NvBlastExtUnity_x64")]
    private static extern void _AuthoringResult_Release(IntPtr authoringResult);
    [DllImport("NvBlastExtUnity_x64")]
    private static extern int _AuthoringResult_GetBondCount(IntPtr authoringResult);
    [DllImport("NvBlastExtUnity_x64")]
    private static extern int _AuthoringResult_GetChunkCount(IntPtr authoringResult);
    [DllImport("NvBlastExtUnity_x64")]
    private static extern IntPtr _AuthoringResult_GetChunkDesc(IntPtr authoringResult, int chunkIndex);
    [DllImport("NvBlastExtUnity_x64")]
    private static extern IntPtr _AuthoringResult_GetBondDesc(IntPtr authoringResult, int bondIndex);

    public NvBlastAuthoringResult(IntPtr me)
    {
        Initialize(me);
    }
    ...
    public int GetBondCount()
    {
        return _AuthoringResult_GetBondCount(this.ptr);
    }

    public int GetChunkCount()
    {
        return _AuthoringResult_GetChunkCount(this.ptr);
    }

    public NvBlastBondDesc GetBondDesc(int bondIndex)
    {
        unsafe
        {
            NvBlastBondDesc* bond = (NvBlastBondDesc*)_AuthoringResult_GetBondDesc(this.ptr, bondIndex);
            return *bond;
        }
    }

    public NvBlastChunkDesc GetChunkDesc(int chunkIndex)
    {
        unsafe
        {
            NvBlastChunkDesc* chunk = (NvBlastChunkDesc*)_AuthoringResult_GetChunkDesc(this.ptr, chunkIndex);
            return *chunk;
        }
    }
    ...
    protected override void Release()
    {
        _AuthoringResult_Release(this.ptr);
    }
}
